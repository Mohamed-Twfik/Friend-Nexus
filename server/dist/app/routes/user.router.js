...
const user_permission_1 = require("../middlewares/auth/user.permission");
...
router.patch("/", (0, fileUpload_1.default)("image", "single", "logo"), (0, user_validator_1.updateUserValidator)(), user_controller_1.updateUser);
