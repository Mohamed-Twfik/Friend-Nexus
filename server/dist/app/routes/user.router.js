...
router.get("/profile/:userId", (0, user_validator_1.validUserId)(), user_permission_1.getOneUserPermission, user_controller_1.getUser);
...
router.patch("/updateRole/:userId", (0, user_validator_1.validUserId)(), user_controller_1.updateRole);
...
router.delete("/:userId", (0, user_validator_1.validUserId)(), user_permission_1.deleteUserPermission, user_controller_1.deleteUser);
